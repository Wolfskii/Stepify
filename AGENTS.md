...
- **Now Playing bar**: **like** before **dislike**; **shuffle** and **repeat** should read clearly as **on** vs **on + hovered** (slightly different treatment) so users see state change after click instead of hover hiding the active styling.
